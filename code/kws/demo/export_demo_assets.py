...
METADATA_CSV = (
    ...
    "data/enhanced_trained_ep176_new_metadata.csv"
)

df_meta = pd.read_csv(METADATA_CSV)
print(df_meta[df_meta["filename"] == "e0315cf6_nohash_3.wav"])

DATA_ROOT = "/home/dsi/skopavi/Project/kws_project/data"
DEMO_ROOT = "/home/dsi/skopavi/Project/kws_project/code/kws/demo"
...
ENHANCED_ROOT = os.path.join(
    DATA_ROOT,
    "enhanced_new/trained_ep176"
)

NOISY_ROOT = os.path.join(
    DATA_ROOT,
    "noisy_new/test"
)
...
"""
    ...
    with open(
        os.path.join(DEMO_ROOT, "index.html"),
        "w",
        encoding="utf-8"
    ) as f:
...
# python /home/dsi/skopavi/Project/kws_project/code/kws/demo/export_demo_assets.py
# cd /home/dsi/skopavi/Project/kws-demo
# ./update_demo.sh